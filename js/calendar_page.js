...
function getInfo() {
    ...
    $.ajax({
        ...
        // },
        url: "https://api.bbichul.shop/info",
...
function updateText() {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: "https://api.bbichul.shop/memo",
        contentType: "application/json",
...
function clickedDayGetMemo(obj) {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: `https://api.bbichul.shop/calendars/memo?dateData=${btn_year_month_day}&calendarType=${selected_cal_now}`,
...
function addCalender() {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: "https://api.bbichul.shop/calendars/option",
        contentType: "application/json",
        data: JSON.stringify(doc),
        success: function (response) {
            alert(response)
...
function getMemo() {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: `https://api.bbichul.shop/calendars/option?calendarType=${selected_cal_now}`,
