...
function get_progressbar() {
    $.ajax({
        type: "POST",
        url: "https://api.bbichul.shop/team/progressbar",
...
function teamCheck() {
    $.ajax({
        type: "GET",
        url: `https://api.bbichul.shop/team`,
        success: function (response) {
...
function invite_team() {
    ...
    if (!invitename || str_space.exec(invitename)) {
        ...
        $.ajax({
            type: "POST",
            url: "https://api.bbichul.shop/team/signup",
            contentType: "application/json",
            data: JSON.stringify(teamname),
            success: function (response) {
...
function teamname_check() {
    ...
    if (!teamname || str_space.exec(teamname)) {
        ...
        $.ajax({
            type: "POST",
            url: "https://api.bbichul.shop/team/checkname",
            contentType: "application/json",
...
function showtask() {
    $.ajax({
        type: "GET",
        url: "https://api.bbichul.shop/team/task",
        success: function (response) {
            get_progressbar()
...
function deletetask(id) {
    ...
    $.ajax({
        type: "POST",
        url: `https://api.bbichul.shop/team/deletetask`,
        contentType: "application/json",
...
function changedone(id) {
    ...
    $.ajax({
        type: "POST",
        url: `https://api.bbichul.shop/team/changetask`,
        contentType: "application/json",
        data: JSON.stringify(taskId),
        success: function () {
            window.location.reload();
...
function checkstatus() {
    ...
    $.ajax({
        type: "GET",
        url: "https://api.bbichul.shop/team/status",
        success: function (response) {
            for (let i = 0; i < response.length; i++) {
